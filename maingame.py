...
try:
    ...
    print("there's exception during opening the file")
# Initializing music.
pygame.mixer.init()
...
try:
    ...
    while True:
        # 'a' and 'b' are the variables that are being used to manipulate coordinates and to check for collisions.
        a = 0
        b = 0
        FPS_change = 0
        FPS = 40
        ...
        while running:
            ...
            # SCORE DISPLAY
            score += Decimal(0.1)
            score_value = font.render("Score : " + str(round(score, 1)), 1, (255, 153, 52))
            high_score = font.render("Top Score: " + str(round(topScore,1)), 1, (255, 153, 52))
            ...
            if score > topScore:
                ...
                Change.write(str(round(score,1)))
                Change.close()
                topScore = score
        gameover()
except:
    print("there are some problems occur during game polling")
